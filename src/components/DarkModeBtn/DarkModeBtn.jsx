...
const DarkModeBtn = () => {
	...
	return (
		<button id="bt" ref={btnRef} onClick={changeDarkMode} className={s.darkModeButton}>
			<img src="/./DemoPortfolio/sun.svg" alt="Light Mode" className={s.darkModeButton__icon} />
			<img src="/./DemoPortfolio/moon.svg" alt="Dark Mode" className={s.darkModeButton__icon} />
		</button>
	)
}
